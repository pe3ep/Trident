...
class ResearchWidget(
    ...
    companion object {
        val RESEARCH_ICONS = hashMapOf<String, ResourceLocation>(
            "Strong" to ResourceLocation.fromNamespaceAndPath("mcc", "textures/island_interface/fishing/strong_research.png"),
            "Wise" to ResourceLocation.fromNamespaceAndPath("mcc", "textures/island_interface/fishing/wise_research.png"),
            "Glimmering" to ResourceLocation.fromNamespaceAndPath("mcc", "textures/island_interface/fishing/glimmering_research.png"),
            "Greedy" to ResourceLocation.fromNamespaceAndPath("mcc", "textures/island_interface/fishing/greedy_research.png"),
            "Lucky" to ResourceLocation.fromNamespaceAndPath("mcc", "textures/island_interface/fishing/lucky_research.png")
        )
    }
    ...
    override val layout = GridLayout(themed.theme.dimensions.paddingInner) {
        ...
        StringWidget(
            Component.literal("${research.tier - 1} ").defaultFont()
                ...
                .append(Component.literal(" (${round(progressPercentage * 10) / 10.0}%)").defaultFont().withStyle(ChatFormatting.GRAY)),
        mcFont).atBottom(0, settings = LayoutConstants.LEFT)
    }
